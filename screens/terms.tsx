            ...
            <ScrollView showsVerticalScrollIndicator={false} style={[GLOBALSTYLES.wrapper, { backgroundColor: '#fff' }]}>
                <View style={{ justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row'}}>
                    ...
                    <TouchableOpacity onPress={() => navigation.goBack()}>
                        ...
                        <Text style={{ fontSize: 20, fontWeight: '700', color: '#000' }}>Terms and Conditions</Text>
                    </View>
                ...
                <View style={{ marginTop: 40 }}>
                  <Text style={{ fontSize: 16, fontWeight: '400', color: '#000', lineHeight: 24 }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sagittis facilisi dolor odio sed venenatis nisi malesuada nisl, eget. Egestas id laoreet imperdiet at natoque molestie pulvinar tincidunt.</Text>
